  ...
  <div class="layout-content-body">
    <div class="title-bar">
      <h1 class="title-bar-title">
        <span class="d-ib">Ajouter une publication</span>
                  ...
                  <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                      <label for="password-1" class="control-label">Budget total du projet</label>
                      <div class="input-group col-md-12">
                         <select id="form-control-6" class="form-control">
                            <option value="c-plus-plus">10 000 000</option>
                            <option value="css">20 000 000</option>
                            <option value="java">30 000 000</option>
                            <option value="javascript">40 000 000</option>
                            <option value="php">10 000 000</option>
                            <option value="python">10 000 000</option>
                            <option value="ruby">10 000 000</option>
                          </select>
                      </div>
                      </div>
                      <div class="form-group">
                      <label for="password-1" class="control-label">Budget Moyen</label>
                      <div class="input-group col-md-12">
                         <select id="form-control-6" class="form-control">
                            <option value="c-plus-plus">10 000 000</option>
                            <option value="css">20 000 000</option>
                      ...
                      <div class="form-group">
                      <label for="password-1" class="control-label">Budget acquis</label>
                      <div class="input-group col-md-12">
                         <select id="form-control-6" class="form-control">
                            <option value="c-plus-plus">10 000 000</option>
                            <option value="css">20 000 000</option>
                      ...
                      <div class="form-group">
                    <label for="email-1" class="control-label">Banner du projet</label>
              ...
              <div id="tab-4" class="tab-pane">
                ...
                <div class="row">
                  ...
                  <input id="form-control-9" type="file" accept="image/*" multiple="multiple">
                    ...
                    <div class="form-group">
                      <button class="btn btn-primary btn-block btn-next" type="button">Sauvegarder</button>
                    </div>
                  </div>
                </div>
              </div>
